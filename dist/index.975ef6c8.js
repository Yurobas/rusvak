...
const mapIcon = new URL(require("ef1794995580cc22"));
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    (function sliderProducts() {
        ...
        if (window.innerWidth >= 1280) options = {
            ...options,
            simulateTouch: false
        };
...
},{"ef1794995580cc22":"jPK81"}],"jPK81":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "logo.cd13699a.svg" + "?" + Date.now();
...
},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequire5128")
