 ...
 */ !function(e, t) {
    ...
    function L1(e38) {
        ...
        !!l.noSwipingClass && "" !== l.noSwipingClass && p.target && p.target.shadowRoot && e38.path && e38.path[0] && (h = d1(e38.path[0]));
        const m = l.noSwipingSelector ? l.noSwipingSelector : `.${l.noSwipingClass}`, f = !(!p.target || !p.target.shadowRoot);
        if (l.noSwiping && (f ? function(e, t26) {
        ...
        }(m, h[0]) : h.closest(m)[0])) return void (t25.allowClick = !0);
        ...
        if (Object.assign(n, {
            ...
            isScrolling: void 0,
            startMoving: void 0
        }), o.startX = g, o.startY = v, n.touchStartTime = u1(), t25.allowClick = !0, t25.updateSize(), t25.swipeDirection = void 0, l.threshold > 0 && (n.allowThresholdMove = !1), "touchstart" !== p.type) {
            let e = !0;
    ...
    const re = [
        ...
        function(e98) {
            ...
            const v = (e99, t56, s)=>{
                ...
                a || i || (t55.isHorizontal() ? t55.el.scrollLeft = 0 : t55.el.scrollTop = 0, t55.slideTo(t55.slides.indexOf(s), 0));
            }, b = ()=>{
                ...
                o = r, a.attr("id", o), function(e, t) {
                    e.attr("aria-live", t);
                }(a, l), b(), t55.navigation && t55.navigation.$nextEl && (d = t55.navigation.$nextEl), t55.navigation && t55.navigation.$prevEl && (u = t55.navigation.$prevEl), d && d.length && v(d, r, e101.nextSlideMessage), u && u.length && v(u, r, e101.prevSlideMessage), g() && t55.pagination.$el.on("keydown", U(t55.params.pagination.bulletClass), m), t55.$el.on("focus", w, !0);
            };
            a21("beforeInit", ()=>{
                i15 = d1(`<span class="${t55.params.a11y.notificationClass}" aria-live="assertive" aria-atomic="true"></span>`);
            }), a21("afterInit", ()=>{
                t55.params.a11y.enabled && x();
            }), a21("slidesLengthChange snapGridLengthChange slidesGridLengthChange", ()=>{
                t55.params.a11y.enabled && b();
                ...
                t55.params.a11y.enabled && function() {
                    let e, s;
                    i15 && i15.length > 0 && i15.remove(), t55.navigation && t55.navigation.$nextEl && (e = t55.navigation.$nextEl), t55.navigation && t55.navigation.$prevEl && (s = t55.navigation.$prevEl), e && e.off("keydown", m), s && s.off("keydown", m), g() && t55.pagination.$el.off("keydown", U(t55.params.pagination.bulletClass), m), t55.$el.off("focus", w, !0);
                }();
            });
        },
        function(e102) {
